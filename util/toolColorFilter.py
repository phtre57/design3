...
cv2.createTrackbar('fileNo', 'result',0,11,nothing)
...
while(1):
    ...
    if (default_values == 1):
      ...
      cv2.putText(text, 'Valeur du filter bleu',
                        (10, 10),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.5, (70, 0, 255), 2)
      cv2.putText(text, color.color_code_hsv_str,
                        (10, 30),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.5, (70, 0, 255), 2)
      ...
      color.RED()
      lower_hsv, upper_hsv = color.color_code_hsv
      cv2.putText(text, 'Valeur du filter rouge',
                        (10, 10),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.5, (70, 0, 255), 2)
      cv2.putText(text, color.color_code_hsv_str,
                        (10, 30),
      ...
      color.GREEN()
      lower_hsv, upper_hsv = color.color_code_hsv
      cv2.putText(text, 'Valeur du filter vert',
                        (10, 10),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.5, (70, 0, 255), 2)
      cv2.putText(text, color.color_code_hsv_str,
                        (10, 30),
      ...
      color.YELLOW()
      lower_hsv, upper_hsv = color.color_code_hsv
      cv2.putText(text, 'Valeur du filter jaune',
                        (10, 10),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.5, (70, 0, 255), 2)
      cv2.putText(text, color.color_code_hsv_str,
                        (10, 30),
      ...
      cv2.putText(text, 'Actual color filter',
                  (10, 10),
                  cv2.FONT_HERSHEY_SIMPLEX, 0.5, (70, 0, 255), 2)
      hsv_str = str(h) + " " + str(s) + " " + str(v) + " | " + str(hu) + " " + str(su) + " " + str(vu)
      cv2.putText(text, hsv_str,
            (10, 30),
            cv2.FONT_HERSHEY_SIMPLEX, 0.5, (70, 0, 255), 2)
