...
class MoveRobotWithEmbarkedCamTest(unittest.TestCase):
    ...
    def test_given_north_when_finding_green_piece_then_piece_is_found(self):
        ...
        if DEBUG:
            cv2.circle(
                img,
                (round(width / 2 + X_OFFSET), round(height / 2) + Y_OFFSET), 5,
                [255, 255, 255])
        ...
        if DEBUG:
            print("In pixel :", x, y)
            print("Factors: ", self.converter.x_pixel_to_mm_factor,
    ...
    # def test_given_west_when_finding_yellow_circle_piece_then_piece_is_found(
    #         self):
    #     print("west")
    ...
    # def test_given_north_when_finding_yellow_circle_piece_then_piece_is_found(
    #         self):
    #     print("north")
    #     img = cv2.imread(self.path + "piece1.jpg")
    #     height, width, channels = img.shape
    ...
    # def test_given_north_when_finding_yellow_circle_piece9_then_piece_is_found(
    #         self):
    #     print("north")
...
def calibrateEmbark():
    ...
    try:
        ...
        path = os.path.join(path, "./calibration_embark.pkl")
