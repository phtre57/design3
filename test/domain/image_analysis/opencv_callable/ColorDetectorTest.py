...
class ColorDetectorTest(unittest.TestCase):
    ...
    def test_givenPieces_whenColorIsGiven_thenFindTheCorrectedPiecesAssociatedToYELLOW(self):
    ...
    def test_givenPieces_whenColorIsGiven_thenFindTheCorrectedPiecesAssociatedToRED(self):
        path = os.path.normpath(os.path.join(os.path.dirname(__file__), os.pardir))
        path = os.path.normpath(os.path.join(path, os.pardir))
        path = os.path.normpath(os.path.join(path, os.pardir))
        path = os.path.normpath(os.path.join(path, os.pardir))
    ...
    def test_givenPieces_whenColorIsGiven_thenFindTheCorrectedPiecesAssociatedToBLUE(self):
        path = os.path.normpath(os.path.join(os.path.dirname(__file__), os.pardir))
        path = os.path.normpath(os.path.join(path, os.pardir))
        path = os.path.normpath(os.path.join(path, os.pardir))
        path = os.path.normpath(os.path.join(path, os.pardir))
    ...
    def test_givenPieces_whenColorIsGiven_thenFindTheCorrectedPiecesAssociatedToGREEN(self):
        path = os.path.normpath(os.path.join(os.path.dirname(__file__), os.pardir))
        path = os.path.normpath(os.path.join(path, os.pardir))
        path = os.path.normpath(os.path.join(path, os.pardir))
        path = os.path.normpath(os.path.join(path, os.pardir))
    ...
    def test_givenPieces_whenColorIsGiven_thenFindTheCorrectedPiecesAssociatedToTEST(self):
        path = os.path.normpath(os.path.join(os.path.dirname(__file__), os.pardir))
        path = os.path.normpath(os.path.join(path, os.pardir))
        path = os.path.normpath(os.path.join(path, os.pardir))
        path = os.path.normpath(os.path.join(path, os.pardir))
