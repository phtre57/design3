...
class AstarTest(unittest.TestCase):
    ...
    def test_givenFullGridWithPathLinesAtLeftAndBottom_whenFindingPath_thenPathIsFound(
            self):
        for u in range(10):
            for w in range(10):
    ...
    def test_givenGridFullExceptLeftAndRightColumnsAndUpRow_whenFindingPath_thenPathFound(
            self):
        for u in range(10):
            for w in range(10):
