...
# output = cv2.morphologyEx(output, cv2.MORPH_CLOSE, cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (10,10)))
# output = cv2.erode(output,kernelerode,iterations = 2)
